...
### Expected Result:
- Page loads without any errors.
- The H1 Title displays "Public Company Directors & Officers Liability Underwriting Products".
...
2. Hover over "Public Companies" in the nav bar and select the second option called "Products".
3. Wait for page to fully load.
4. Verify the second h3 title and bullet points underneath.
...
2. Hover over "Public Companies" in the nav bar and select the second option called "Products".
3. Wait for page to fully load.
4. Verify the third h3 title and bullet points underneath.
...
# TC-007: Verify Contact Us Button
**Priority**: High
**Type**: Functional/Smoke
**Preconditions**: 
- Have a computer/laptop connected to the internet.
...
# TC-008: Verify Performance Metrics
**Priority**: High
**Type**: Functional/Smoke
**Preconditions**: 
- Have a computer/laptop connected to the internet.
...
2. Hover over "Public Companies" in the nav bar and select the second option called "Products".
3. Wait for page to fully load.
4. Record the accessibility metrics.
