...
@pytest.mark.ui
@pytest.mark.careers
def test_email_popup_submit_resume_button(page: Page, base_url):
    """Verify the "Submit Your Resume" button in the email popup on the job details page"""
    ...
    # Verify the "Submit Your Resume" button in the email popup
